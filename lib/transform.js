(function() {
    ...
    class Transformer {
        ...
        getArrayNode0(node) {
            ...
            else throw new Error('Malformed xml2js output, expected array and got «'+type(node)+'»!').setName('InvalidJSONException');
        }
    };
